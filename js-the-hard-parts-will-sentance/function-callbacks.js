...
function divide2(input) { return input / 2 }
function multiply2(input) { return input * 2 }

const addResult = copyArrayAndManipulate(myArray, add2);
const divideResult = copyArrayAndManipulate(myArray, divide2);
const multiplyResult = copyArrayAndManipulate(myArray, multiply2);
